...
<body
    ...
    style="background-image: url('{{ asset('assets/images/gallery/intro-features.png') }}')">
    <div class="row">
        <div class="col s12">
            <div class="container">
                        ...
                        <form class="login-form" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <center><img src="{{ asset('assets/images/logo/2.png') }}" alt="logo"
                                            style="width: 170px; height: 170px; margin-top: 0px"></center>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s12">
                                    <center>
                                        <h5>Koperasi Aneka Usaha Sido Makmur</h5>
                                    </center>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s12">
                                    ...
                                    <p class="ml-4">Silahkan masuk ke akun anda.</p>
                                </div>
                            </div>
